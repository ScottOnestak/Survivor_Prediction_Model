#title: Survivor_Winner_Model_Historical
...
#Edge of Extinction Re-Weighting...only run for season 38
score2 = score
    ...
    if(is.na(score[i,j])==T){
      ...
      if(j == 3){
        ...
        if(score[i,1]=="Reem Daly" |
          ...
          score2[i,j] = (1 + (15-12-6*((1/6 + (1/6)*(7/13)*(1/13) + (5/6)*(1/13))))/12) * score[i,j]
        }
      } else if(j == 8){
        if(score[i,1]=="Reem Daly" |
           score[i,1]=="Chris Underwood" |
